...
<!-- Mirrored from html.themehour.net/faren/demo/project.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 18 Sep 2025 06:31:47 GMT -->

<head>
    <meta charset="utf-8">
    <meta http-equiv="x-ua-compatible" content="ie=edge">
    <title>Faren - Architecture & Interior Design Template - Our Portfolio</title>
    ...
    <section class="position-relative space-top overflow-hidden" id="project-sec">
        <div class="container">
            <div class="row gy-4 space-bottom">
                <div class="col-lg-5">
                    <div class="title-area mb-0"><span class="number wow fadeInLeft" data-wow-delay=".2s">01 <span class="line"></span>04</span>
                        <h2 class="sec-title split-text">Excellence Kitchen Interior Design</h2>
                        <p class="sec-text3 wow fadeInUp" data-wow-delay=".3s">Faren architects is a team of young talented experts whose professional activity is entirely dedicated to creating unique architectural and design solutions.</p>
                        <div class="wow fadeInUp" data-wow-delay=".4s"><a href="project-details.html" class="th-btn black-border th-icon">View Projects</a></div>
                    </div>
                    <div class="shape-mockup spin d-none d-xxl-block" data-bottom="8%" data-right="12%"><img src="assets/img/shape/element-5.png" alt=""></div>
                </div>
                <div class="col-lg-7">
                    <div class="img-box6">
            ...
            <div class="row gy-4 space-bottom flex-row-reverse justify-content-between">
                <div class="col-lg-5">
                    <div class="title-area mb-0 ps-xl-5 ms-xl-5"><span class="number wow fadeInLeft" data-wow-delay=".2s">02 <span class="line"></span>04</span>
            ...
            <div class="row gy-4 space-bottom justify-content-between">
                <div class="col-lg-5">
                    <div class="title-area mb-0"><span class="number wow fadeInLeft" data-wow-delay=".2s">03 <span class="line"></span>04</span>
            ...
            <div class="row gy-4 flex-row-reverse justify-content-between">
                <div class="col-lg-5">
                    <div class="title-area mb-0 ps-xl-5 ms-xl-4"><span class="number wow fadeInLeft" data-wow-delay=".2s">04 <span class="line"></span>04</span>
            ...
            <div class="row">
                <div class="project-list-area">
                    <div class="project-list">
                        ...
                        <div class="box-right">
                            <div class="box-img"><img src="assets/img/project/project-img-1.png" alt=""></div><a href="project-details.html" class="th-btn black-border th-icon">View Projects</a>
                        </div>
                    </div>
                    <div class="project-list">
...
<!-- Mirrored from html.themehour.net/faren/demo/project.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 18 Sep 2025 06:31:49 GMT -->
