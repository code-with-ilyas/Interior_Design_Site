                ...
                <div class="p-6 text-gray-900">
                    ...
                    <div class="mt-8">
                        ...
                        <div class="flex flex-wrap gap-4">
                            <a href="{{ route('admin.users.index') }}" class="px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-600">Manage Users</a>
                            ...
                            <a href="{{ route('admin.services.index') }}" class="px-4 py-2 bg-yellow-500 text-white rounded hover:bg-yellow-600">Manage Services</a>
