    ...
    <section id="customers-sec" class="clients py-6 px-4 bg-gray-100">
        <div class="columns grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div class="column fade-in border rounded p-4 bg-white shadow-sm">
                ...
                <br>
                <!-- {{-- Logo --}}
                <h6 class="text-gray-500 font-semibold mb-1">Logo</h6>
                @if($customer->logo)
                <img src="{{ Storage::url($customer->logo) }}" class="mx-auto h-16 w-auto object-contain mb-3">
                @else
                <p class="text-gray-400 text-sm mb-3">No logo uploaded</p>
                @endif -->
