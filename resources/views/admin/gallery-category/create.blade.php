        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <h3 class="text-lg font-medium mb-4">Add New Gallery Category</h3>
                    ...
                    <form method="POST" action="{{ route('admin.gallery-categories.store') }}">
                        ...
                        <div class="mt-6 flex items-center justify-end">
                            <a href="{{ route('admin.gallery-categories.index') }}" class="mr-3 px-4 py-2 bg-gray-500 text-white rounded hover:bg-gray-600">Cancel</a>
