                    ...
                    <form method="POST" action="{{ route('admin.testimonials.update', $testimonial) }}" enctype="multipart/form-data">
                        ...
                        <div class="mb-6">
                            ...
                            <textarea name="testimonial_text" id="testimonial_text" rows="5"
                                      class="w-full border border-gray-300 rounded-md shadow-sm px-4 py-2 focus:ring-blue-500 focus:border-blue-500" required
                                      placeholder="Enter the client's testimonial here...">{{ old('testimonial_text', $testimonial->testimonial_text) }}</textarea>
                        ...
                        <div class="mb-6">
                            ...
                            @if($testimonial->client_image)
                                <div class="mb-3">
                                    <img src="{{ asset('storage/' . $testimonial->client_image) }}" alt="Current Image" class="h-20 w-20 rounded-full object-cover mb-2">
                        ...
                        <div class="mb-6">
                            ...
                            <input type="number" name="sort_order" id="sort_order" value="{{ old('sort_order', $testimonial->sort_order) }}"
                                   class="w-full border border-gray-300 rounded-md shadow-sm px-4 py-2 focus:ring-blue-500 focus:border-blue-500"
                                   min="0" placeholder="0">
                            <p class="mt-1 text-sm text-gray-500">Lower numbers appear first. Current value: {{ $testimonial->sort_order }}</p>
                            @error('sort_order')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
