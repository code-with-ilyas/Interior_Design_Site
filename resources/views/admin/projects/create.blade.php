                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="file" name="cover_image" id="cover_image" accept="image/*" required
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                                <p class="mt-1 text-sm text-gray-500">Upload a cover image (JPG, PNG, GIF) - Max 2MB</p>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="surface_area" id="surface_area" value="{{ old('surface_area') }}"
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                            </div>

                            <div>
                                <label for="condition_before" class="block text-sm font-medium text-gray-700">Condition Before</label>
                                <input type="text" name="condition_before" id="condition_before" value="{{ old('condition_before') }}"
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="cost_currency" id="cost_currency" value="{{ old('cost_currency', '€') }}" maxlength="10"
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                            </div>

                            <div>
                                <label for="duration_weeks" class="block text-sm font-medium text-gray-700">Duration (weeks)</label>
                                <input type="number" name="duration_weeks" id="duration_weeks" value="{{ old('duration_weeks') }}" min="0"
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                            </div>

                            <div>
                                <label for="completion_year" class="block text-sm font-medium text-gray-700">Completion Year</label>
                                <input type="number" name="completion_year" id="completion_year" value="{{ old('completion_year') }}" min="1900" max="{{ date('Y') + 5 }}"
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                            </div>

                            <div>
                                <label for="co2_avoided_per_year" class="block text-sm font-medium text-gray-700">CO2 Avoided Per Year</label>
                                <input type="text" name="co2_avoided_per_year" id="co2_avoided_per_year" value="{{ old('co2_avoided_per_year') }}"
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="architect_name" id="architect_name" value="{{ old('architect_name') }}"
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                            </div>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea name="materials_used" id="materials_used" rows="3"
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">{{ old('materials_used') }}</textarea>
                            </div>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea name="challenges" id="challenges" rows="3"
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">{{ old('challenges') }}</textarea>
                            </div>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea name="result_highlights" id="result_highlights" rows="3"
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">{{ old('result_highlights') }}</textarea>
                            </div>
